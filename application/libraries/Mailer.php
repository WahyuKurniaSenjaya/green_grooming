...
{
    protected $_ci;
    protected $email_pengirim = 'messagebot.maxwell@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Messsage Bot - Maxwell'; // Isikan dengan nama pengirim
    protected $password = 'jaauawveqtdokoik'; // Isikan dengan password email pengirim
    ...
    public function send($data)
    {
        ...
        $mail->AddEmbeddedImage('assets/logo_email/logo.png', 'logo_maxwell', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
        $send = $mail->send();
    ...
    public function send_with_attachment($data)
    {
        ...
        $mail->Subject = $data['subjek'];
        $mail->Body = $data['content'];
        $mail->AddEmbeddedImage(base_url() . 'assets/logo_email/logo.png', 'logo_maxwell', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
