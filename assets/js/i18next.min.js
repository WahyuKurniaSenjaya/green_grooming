!(function (t, e) {
	...
	function n(t, e, n) {
		...
		for (
			var r = "string" != typeof e ? [].concat(e) : e.split(".");
			r.length > 1;
		...
		(t.lng = function () {
			...
			(t.setLng = function (e, n, o) {
				return (
					...
					n || (n = {}),
					n.fixLng === !0 && o
						? o(null, t.getFixedT(e))
						: void t.changeLanguage(e, o)
				);
			}),
		...
		return (
			A.forEach(function (e) {
				e.lngs.forEach(function (n) {
					return (t[n] = { numbers: e.nr, plurals: H[e.fc] });
				});
			}),
			t
		);
	...
	var x =
		...
		j = (function () {
			...
			return (
				...
				(t.prototype.create = function (e) {
					var n = new t(
						this.logger,
						k({ prefix: this.prefix + ":" + e + ":" }, this.options)
					);
					return n;
				}),
				t
			...
			return (
				...
				(e.prototype.addResource = function (t, e, n, r) {
					...
					n && (s = s.concat(a ? n.split(a) : n)),
						t.indexOf(".") > -1 && ((s = t.split(".")), (r = e), (e = s[1])),
			...
			return (
				...
				(n.prototype.exists = function (t) {
					var e =
						arguments.length > 1 && void 0 !== arguments[1]
							...
							: { interpolation: {} };
					return (
						"v1" === this.options.compatibilityAPI && (e = f(e)),
				...
				(n.prototype.translate = function (t) {
					...
					if (s && "cimode" === s.toLowerCase()) {
						if (l) {
							var u = e.nsSeparator || this.options.nsSeparator;
							return a + u + r;
						}
						return r;
					}
					...
					if (
						...
						if (!e.returnObjects && !this.options.returnObjects)
							return (
								...
								this.options.returnedObjectHandler
									? this.options.returnedObjectHandler(r, c, e)
									: "key '" +
									  r +
									  " (" +
									  this.language +
						...
						if (e.keySeparator || this.options.keySeparator) {
							var d = "[object Array]" === p ? [] : {};
							for (var v in c)
								d[v] = this.translate(
									"" + r + n + v,
									k({}, e, { joinArrays: !1, ns: i })
								);
							c = d;
						}
					} else if (h && "[object Array]" === p)
						(c = c.join(h)), c && (c = this.extendTranslation(c, r, e));
					else {
						var y = !1,
							b = !1;
						if (
							(this.isValidLookup(c) ||
								...
								((y = !0), (c = e.defaultValue)),
							this.isValidLookup(c) || ((b = !0), (c = r)),
							b || y)
						) {
							this.logger.log("missingKey", s, a, r, c);
							var m = [],
							...
							this.options.saveMissing &&
								(this.options.missingKeyHandler
									? this.options.missingKeyHandler(m, a, r, c)
									: this.backendConnector &&
									  this.backendConnector.saveMissing &&
									  this.backendConnector.saveMissing(m, a, r, c)),
								this.emit("missingKey", m, a, r, c);
						}
						(c = this.extendTranslation(c, r, e)),
							b &&
								c === r &&
				...
				(n.prototype.extendTranslation = function (t, e, n) {
					...
					this.options.interpolation.defaultVariables &&
						(r = k({}, this.options.interpolation.defaultVariables, r)),
						(t = this.interpolator.interpolate(t, r, this.language)),
										...
										u.forEach(function (r) {
											if (!e.isValidLookup(o)) {
												var a = i,
													u = [a],
													c = void 0;
												s && (c = e.pluralResolver.getSuffix(r, n.count)),
													s && l && u.push(a + c),
													l &&
														u.push(
															(a += "" + e.options.contextSeparator + n.context)
														),
													s && u.push((a += c));
												for (var p = void 0; (p = u.pop()); )
						...
						"string" == typeof t && t.indexOf("-") > -1
							? ("languageOnly" !== this.options.load &&
							  ...
							  "languageOnly" !== this.options.load &&
									...
									i(this.getScriptPartFromCode(t), !0),
							  "currentOnly" !== this.options.load &&
		...
		V = (function () {
			function e() {
				var t =
					arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
				S(this, e), (this.logger = C.create("interpolator")), this.init(t, !0);
			}
			return (
				(e.prototype.init = function () {
					...
					(this.escapeValue = void 0 === n.escapeValue || n.escapeValue),
						(this.prefix = n.prefix ? s(n.prefix) : n.prefixEscaped || "{{"),
						(this.suffix = n.suffix ? s(n.suffix) : n.suffixEscaped || "}}"),
						...
						(this.nestingPrefix = n.nestingPrefix
							? s(n.nestingPrefix)
							: n.nestingPrefixEscaped || s("$t(")),
						(this.nestingSuffix = n.nestingSuffix
							? s(n.nestingSuffix)
							: n.nestingSuffixEscaped || s(")")),
						this.resetRegExp();
				}),
				...
				(e.prototype.interpolate = function (e, n, o) {
					...
					for (this.resetRegExp(); (s = this.regexpUnescape.exec(e)); ) {
						var c = u(s[1].trim());
						(e = e.replace(s[0], c)), (this.regexpUnescape.lastIndex = 0);
					}
			...
			return (
				...
				(e.prototype.queueLoad = function (t, e, n) {
					...
					return (
						...
						{ toLoad: r, pending: i, toLoadLanguages: a, toLoadNamespaces: s }
					);
				}),
				(e.prototype.loaded = function (t, e, n) {
					var o = this,
						...
						s = a[0],
						l = a[1];
					e && this.emit("failedLoading", s, l, e),
				...
				(e.prototype.read = function (t, e, n, o, r, i) {
					...
					return (
						...
						r || (r = 250),
						t.length
							? void this.backend[n](t, e, function (s, l) {
									return s && l && o < 5
				...
				(e.prototype.load = function (t, e, n) {
					...
					if (!a.toLoad.length) return void (a.pending.length || n());
					if (r.allowMultiLoading && this.backend.readMulti)
						...
						var s = function (t) {
							...
							this.read(r, i, "read", null, null, function (n, o) {
								n &&
									e.logger.warn(
										"loading namespace " + i + " for language " + r + " failed",
										n
									),
									!n &&
										o &&
										e.logger.log(
											"loaded namespace " + i + " for language " + r,
											o
										),
									e.loaded(t, n, o);
							});
							...
							this.read(r, i, "read", null, null, function (n, o) {
								n &&
									...
									!n &&
										o &&
										e.logger.log(
											"reloaded namespace " + i + " for language " + r,
											o
										),
									e.loaded(t, n, o);
							});
		...
		F = (function (t) {
			function e(n, o, r) {
				...
				return (
					...
					(a.services = r),
					(a.options = i),
					(a.logger = C.create("cacheConnector")),
					a.cache && a.cache.init && a.cache.init(r, i.cache, i),
					a
				);
			}
			return (
				...
				(e.prototype.load = function (t, e, n) {
					...
					"string" == typeof t &&
						...
						"string" == typeof e && (e = [e]),
						r.enabled
							? this.cache.load(t, function (e, r) {
									if (
										(e &&
											o.logger.error(
												"loading languages " +
		...
		K = (function (t) {
			function e() {
				...
				return (
					...
					(r.logger = C),
					(r.modules = { external: [] }),
					!o || r.isInitialized || n.isClone || r.init(n, o),
					r
				);
			}
			return (
				...
				(e.prototype.init = function (t, e) {
					...
					if (
						...
						"v1" === t.compatibilityAPI
							? (this.options = k({}, y(), b(c(t)), {}))
							: "v1" === t.compatibilityJSON
							? (this.options = k({}, y(), b(p(t)), {}))
							: (this.options = k({}, y(), this.options, b(t))),
						e || (e = m),
						!this.options.isClone)
					) {
						this.modules.logger
							? C.init(n(this.modules.logger), this.options)
						...
						(i.logger = C),
							...
							this.modules.languageDetector &&
								((i.languageDetector = n(this.modules.languageDetector)),
					...
					var s = function () {
						o.changeLanguage(o.options.lng, function (t, n) {
							(o.isInitialized = !0),
								o.logger.log("initialized", o.options),
				...
				(e.prototype.use = function (t) {
					return (
						...
						"postProcessor" === t.type && _.addPostProcessor(t),
						...
						o = function t(e) {
							var o =
									arguments.length > 1 && void 0 !== arguments[1]
										...
										: {},
								r = k({}, o);
							return (r.lng = r.lng || t.lng), (r.ns = r.ns || t.ns), n.t(e, r);
						};
				...
				(e.prototype.dir = function (t) {
					if ((t || (t = this.language), !t)) return "rtl";
					var e = [
						"ar",
						"shu",
						"sqr",
