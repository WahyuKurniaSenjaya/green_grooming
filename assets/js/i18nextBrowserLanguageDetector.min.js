!(function (e, t) {
	"object" == typeof exports && "undefined" != typeof module
		...
		? define(t)
		: (e.i18nextBrowserLanguageDetector = t());
})(this, function () {
	"use strict";
	function e(e) {
		return (
			a.call(i.call(arguments, 1), function (t) {
				if (t) for (var o in t) void 0 === e[o] && (e[o] = t[o]);
			}),
			e
		);
	}
		...
		u = {
			...
			cacheUserLanguage: function (e, t) {
				t.lookupCookie &&
					...
					r.create(t.lookupCookie, e, t.cookieMinutes, t.cookieDomain);
			},
		},
		c = {
			name: "querystring",
							...
							t || (t = this.options.caches),
								t &&
									t.forEach(function (t) {
										o.detectors[t] &&
											o.detectors[t].cacheUserLanguage(e, o.options);
									});
						},
					},
				]),
	...
	return (h.type = "languageDetector"), h;
});
